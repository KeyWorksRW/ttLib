...
public:
    ...
    bool WriteString(const char* pszKey, const char* pszValue) { return (RegSetValueEx(m_hkey, pszKey, 0, REG_SZ, (PBYTE) pszValue, (DWORD) ttStrLen(pszValue) + 1) == ERROR_SUCCESS); }
