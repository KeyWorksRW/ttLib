...
// std::iterator is deprecated in C++17, so octet_iterator class updated.
...
namespace utf8
{
    namespace unchecked
    {
        ...
        template<typename octet_iterator> inline uint32_t previous(octet_iterator& it)
        {
