...
// needs a return value if lResult needs to be something other then 0.

#pragma once

#ifndef __DLG_ID__
    #ifdef _DEBUG
        // use this to confirm you have a valid dialog id--it will generate an assertion message if the id doesn't exist at runtime
