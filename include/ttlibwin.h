/////////////////////////////////////////////////////////////////////////////
// Name:      ttlibwin.h
// Purpose:   Master header file for ttLibwin
// Author:    Ralph Walden
...
inline bool ttChDir(const char* pszDir)
{
    return (SetCurrentDirectoryA(pszDir) != FALSE);
}
// clang-format on
...
inline bool ttChDir(const wchar_t* pwszDir)
{
    return (SetCurrentDirectoryW(pwszDir) != FALSE);
}
