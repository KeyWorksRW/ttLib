/////////////////////////////////////////////////////////////////////////////
// Name:		ttmsgs.h
// Purpose:		WTL-like messages
// Author:		Microsoft Corporation, derivative work by Ralph Walden
// Copyright (C) Microsoft Corporation, WTL Team. All rights reserved.
// Licence:     Microsoft Public License (see ../MS-PL.txt)
/////////////////////////////////////////////////////////////////////////////

// [randalphwa - 05-05-2003] This is derived from atlcrack.h, modified to add additional msgs, tweak existing
// msgs, and to be usable without ATL or WTL needed

#pragma once

#ifndef __TTLIB_TTMSGS_H__
#define __TTLIB_TTMSGS_H__

// --------------- Start Additions --------------------

#ifndef GET_X_LPARAM
#define GET_X_LPARAM(lParam)	((int)(short)LOWORD(lParam))	// note that this returns a signed value
#endif
#ifndef GET_Y_LPARAM
#define GET_Y_LPARAM(lParam)	((int)(short)HIWORD(lParam))	// note that this returns a signed value
#endif
...
#define MSG_WM_NCMOUSEMOVE(func) \
	...
	{ \
		func((size_t) wParam, GET_LOW_LPARAM(lParam), GET_HIGH_LPARAM(lParam)); \
		lResult = 0; \
		return TRUE; \
	}

// The following are designed to avoid using any ATL/WTL classes
...
#define MSG_WM_MOUSEWHEEL(func) \
	...
	{ \
		lResult = (LRESULT)func((UINT)LOWORD(wParam), (short)HIWORD(wParam), GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam)); \
		return TRUE; \
		}
